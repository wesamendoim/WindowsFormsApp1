...
namespace WindowsFormsApp1
{
    ...
    {
        public static string HostName = @"elevenchimp-dev.c3zhauyqfcde.us-east-1.rds.amazonaws.com";
        public static string Login = @"bd_petnativa_dev";
        public static string Password = @"vRR6gBTA5xYrvHZM";
        public static string filePathProject = System.IO.Directory.GetCurrentDirectory();
